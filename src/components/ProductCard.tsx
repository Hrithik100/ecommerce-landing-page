...
const ProductCard = ({ id, img, category, title, price }: propsType) => {
  ...
  return (
    <div className="border border-gray-200">
      ...
      <div className="mt-3 flex test-[#ffb21d] items-center">
        <AiFillStar/>
        <AiFillStar/>
        <AiFillStar/>
        <AiFillStar/>
      ...
      <div className="flex justify-between items-center mt-4">
        ...
        <div className="flex gap-2 items-center bg-pink text-white px-4 p-2 cursor-pointer hover:bg-accent" onClick={addProductToCart}>
