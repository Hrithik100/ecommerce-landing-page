...
const Navbar = ({setShowCart}:any) => {
  ...
  return (
    <nav className="pt-4 bg-white top-0 sticky">
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex gap-4 md:gap-8 items-center">
            ...
            <div className="text-gray-500 text-[32px] relative" onClick={() => setShowCart(true)}>
              ...
              <div className="absolute top-[-15px] right-[-15px] bg-red-600 w-[25px] h-[25px] rounded-full text-white text-[14px] grid place-items-center ">
                {cartCount}
              </div>
            </div>
          </div>
